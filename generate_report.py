...
pdf.image("charts/Monthly Sales.png", x=10, w=180)
...
pdf.image("charts/Top 10 Products.png", x=10, w=180)
...
pdf.image("charts/Sales By Category.png", x=10, w=180)
...
pdf.image("charts/Sales By Region.png", x=10, w=180)
